  ...
  return (
    <div className="h-full flex flex-col bg-zinc-900">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-700 bg-zinc-800">
        ...
        <div
          className="relative w-10 h-10 rounded-full overflow-hidden border border-zinc-600 cursor-pointer group"
        ...
        <div className="w-full bg-zinc-800 rounded-3xl border border-zinc-700 shadow-lg p-3">
          ...
          <div className="flex items-end gap-3 bg-zinc-900 rounded-2xl border border-zinc-700/50 focus-within:border-emerald-500 p-3">
            ...
            <textarea
              ...
              className="flex-1 bg-transparent text-zinc-100 placeholder-zinc-500 text-[17px] resize-none max-h-32 py-3 focus:outline-none"
            />

            <button
              onClick={handleSend}
              disabled={!message.trim()}
              className="p-3 bg-emerald-500 hover:bg-emerald-600 disabled:bg-zinc-700 disabled:text-zinc-400 rounded-2xl transition-all active:scale-95"
            >
              <Send size={26} />
            </button>
          </div>
