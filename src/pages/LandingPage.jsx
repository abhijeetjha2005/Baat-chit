  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-zinc-950 to-black flex items-center justify-center p-6'>
      <div className='max-w-md w-full text-center'>
        ...
        >
          {/* Box container for the logo */}
          <div className='w-32 h-32'>
            {/* Fixed: set width and height to 100% so it respects the parent wrapper size */}
            <svg width="100%" height="100%" viewBox="0 0 280 280" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <text x="140" y="245" textAnchor="middle" fill="#F1F5F9" fontFamily="Arial Black, sans-serif" fontSize="29" fontWeight="900" letterSpacing="1" style={{ filter: "drop-shadow(2px 3px 3px rgba(0,0,0,0.4))" }}>
                बात-चीत
              </text>
            </svg>
          </div>
        ...
        {/* login */}
        <div className='bg-zic-900/80 backdrop-blur-xl border border-zinc-700 rounded-3xl p-8'>
        ...
        {/* sign up */}
        <p className='text-zinc-400 mt-6 text-sm'>Don't have an account?{' '}</p>
